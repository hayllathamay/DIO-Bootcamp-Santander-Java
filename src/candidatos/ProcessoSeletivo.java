...
public class ProcessoSeletivo {
 public static void main(String[] args) {
   ...
   // System.out.println(" ");
    ...
    String [] candidatos = {"LAURA", "MARCIA", "MARCOS", "FONSECA", "LUIZ" , "ANA"};
  ...
  static void entrandoEmContato(String candidato){
   ...
   static void imprimindoSelecionados() {
    String [] candidatos = {"LAURA", "MARCIA", "MARCOS", "FONSECA", "LUIZ"};
   ...
   String [] candidatos = {"LUANA", "MARCIA", "LETICIA", "PAULO", "AUGUSTO", "MONICA", "FABRICIO", "MIRELA", "DANIELA", "JUNIOR"}; 
